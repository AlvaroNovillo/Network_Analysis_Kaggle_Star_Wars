...
To further investigate the relationship between the total screenplay of the characters and the number of interactions, we created a barplot showing the top 10 characters with the highest screenplayt, allowing us to compare the total screenplay of each character with their corresponding number of interactions. 
```{r}
