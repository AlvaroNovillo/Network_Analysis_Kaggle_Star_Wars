...
plot(starwars_fg,giant_component,main="Karate network with maximal modularity")
```
...
plot(starwars_lv,giant_component,main="Karate network with maximal modularity")
```
...
plot(starwars_lp,giant_component,main="Karate network with maximal modularity")
```
...
plot(starwars_wa,giant_component,main="Karate network with maximal modularity")
```
